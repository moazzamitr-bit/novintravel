      ...
      <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_300px]">
        <div className="space-y-5">
          <section className="rounded-[22px] border border-novin-border bg-white p-5 sm:p-6">
            <h2 className="text-[16px] font-bold text-novin-text">روش پرداخت</h2>
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      active
                        ? "border-novin-purple bg-[color-mix(in_srgb,var(--color-novin-purple)_6%,white)]"
                        : "border-novin-border hover:border-novin-purple/40",
                    )}
                  >
                    <span className="inline-flex h-10 w-10 items-center justify-center rounded-xl bg-novin-bg-secondary text-novin-purple">
                      <Icon className="h-5 w-5" />
                    </span>
                    <span>
                      <span className="block text-[14px] font-bold text-novin-text">
                        {itemMethod.title}
                      </span>
          ...
          <section className="rounded-[22px] border border-novin-border bg-white p-5 sm:p-6">
            <h2 className="text-[16px] font-bold text-novin-text">کد تخفیف</h2>
            <div className="mt-3 flex gap-2">
              <input
                value={discount}
                onChange={(e) => setDiscount(e.target.value)}
                placeholder="مثلاً NOVIN1405"
          ...
          <section className="rounded-[22px] border border-novin-border bg-white p-5 sm:p-6">
            <label className="flex cursor-pointer items-start gap-3">
              ...
              />
              <span className="text-[14px] leading-7 text-novin-text-secondary">
                قوانین و مقررات نوین تراول، شرایط استرداد و قیمت نهایی را می‌پذیرم.
              </span>
            </label>
          </section>
