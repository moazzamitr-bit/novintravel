    ...
    <div className="space-y-4">
          ...
          return (
            <button
              ...
              className={cn(
                ...
                selected
                  ? "bg-novin-purple text-white shadow-soft"
      ...
      <div className="overflow-visible rounded-2xl border border-novin-border">
        <div className="flex flex-col lg:flex-row lg:items-stretch">
          <div className="relative flex min-w-0 flex-[1.35] flex-col sm:flex-row">
            ...
            <div className="relative z-10 flex items-center justify-center sm:px-0">
              <button
                ...
                className={cn(
                  "absolute left-1/2 top-1/2 flex h-10 w-10 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-novin-purple text-white shadow-soft transition-transform duration-300 hover:bg-novin-purple-dark sm:static sm:translate-x-0 sm:translate-y-0",
                  swapping && "rotate-180",
                )}
              >
            ...
            <div className="hidden w-px bg-novin-border sm:block" />
            <DestinationSelector
              label="مقصد"
          ...
          <div className="hidden w-px bg-novin-border lg:block" />
          <div className="h-px bg-novin-border lg:hidden" />
