  ...
  return (
    <>
      {items.map((item) => (
        <article
          key={item.id}
          className="rounded-[20px] border border-novin-border bg-white p-4 sm:p-5 transition hover:-translate-y-0.5 hover:shadow-card"
        >
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div className="min-w-0 flex-1">
              ...
              <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-3">
                <div>
                  <p className="text-[20px] font-bold text-novin-text">
                    {item.departTime}
                  </p>
                ...
                <div className="text-center text-[12px] text-novin-text-muted">
                  <p>{item.duration}</p>
                  <div className="my-1 h-px w-14 bg-novin-border sm:w-20" />
                </div>
