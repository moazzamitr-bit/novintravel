...
export function InstallmentCalculatorDemo() {
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
      <div className="rounded-[22px] border border-novin-border bg-white p-5 sm:p-7">
        <p className="text-[13px] font-medium text-novin-orange">ماشین‌حساب دمو</p>
        <h2 className="mt-2 text-[22px] font-bold text-novin-text">
          برنامه اقساط سفر را ببینید
        </h2>
        <label className="mt-6 block text-[13px] text-novin-text-secondary">
          مبلغ کل سفر (تومان)
          <input
            type="range"
            min={10000000}
            ...
            className="mt-3 w-full accent-[var(--color-novin-purple)]"
          />
          <span className="mt-2 block text-[20px] font-bold text-novin-purple">
