          ...
          >
            ...
            <div className="p-4">
              <div className="flex items-start justify-between gap-3">
                ...
                <div className="inline-flex items-center gap-1 rounded-lg bg-novin-purple px-2 py-1 text-[12px] font-bold text-white">
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                {hotel.tags.map((tag) => (
                  <span
                    key={tag}
                    className="rounded-full bg-novin-bg-secondary px-2.5 py-1 text-[11px] text-novin-text-secondary"
                  >
                    {tag}
                  </span>
                ))}
              ...
              <div className="mt-4 flex items-center justify-between gap-3">
                <div>
                  <p className="text-[12px] text-novin-text-muted">شروع از</p>
                  <p className="text-[18px] font-bold text-novin-purple">
                    {priceLabel(hotel.priceFrom)}
                  </p>
                  <p className="text-[11px] text-novin-text-muted">
