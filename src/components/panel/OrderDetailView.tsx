    ...
    <div className="space-y-6">
      ...
      >
        <dl className="grid gap-4 sm:grid-cols-2 text-[14px]">
          <div className="rounded-2xl bg-novin-bg-secondary p-4">
            <dt className="text-novin-text-muted">نوع خدمت</dt>
            <dd className="mt-1 font-bold text-novin-text">{order.type}</dd>
          </div>
          <div className="rounded-2xl bg-novin-bg-secondary p-4">
            <dt className="text-novin-text-muted">وضعیت</dt>
            <dd className="mt-1">
              <span
          ...
          <div className="rounded-2xl bg-novin-bg-secondary p-4 sm:col-span-2">
            <dt className="text-novin-text-muted">جزئیات</dt>
            <dd className="mt-1 font-bold text-novin-text">{order.title}</dd>
          </div>
          <div className="rounded-2xl bg-novin-bg-secondary p-4">
            <dt className="text-novin-text-muted">تاریخ</dt>
            <dd className="mt-1 font-bold text-novin-text">{order.date}</dd>
          </div>
          <div className="rounded-2xl bg-novin-bg-secondary p-4">
            <dt className="text-novin-text-muted">مبلغ</dt>
            <dd className="mt-1 font-bold text-novin-purple">
...
export function OrderNotFound({ backHref }: { backHref: string }) {
  return (
    <PanelCard title="سفارش یافت نشد">
      <p className="text-[14px] text-novin-text-secondary">
        این شماره سفارش در داده دمو وجود ندارد.
      </p>
      <Link href={backHref} className="mt-4 inline-flex text-novin-purple">
        بازگشت
      </Link>
    </PanelCard>
  );
