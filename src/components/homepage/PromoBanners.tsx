...
export function PromoBanners() {
  return (
    <section className="container-page section-spacing !pb-0" aria-label="پیشنهادهای ویژه">
      <div className="grid gap-4 lg:grid-cols-2 lg:gap-5">
        <article className="relative overflow-hidden rounded-[20px] bg-novin-purple px-6 py-8 text-white sm:px-8 sm:py-10 min-h-[220px]">
          <div className="pointer-events-none absolute -left-6 top-1/2 h-44 w-44 -translate-y-1/2 rounded-full bg-novin-orange/20 blur-2xl" />
          <div className="relative z-10 flex h-full flex-col justify-between gap-6 sm:flex-row sm:items-center">
            ...
            <div className="relative mx-auto flex h-28 w-28 items-center justify-center sm:mx-0 sm:h-36 sm:w-36">
              <div className="absolute inset-0 rotate-12 rounded-[28px] bg-gradient-to-br from-novin-orange to-[#ff7a3d] shadow-[0_20px_40px_rgba(0,0,0,0.25)]" />
        ...
        <article className="relative min-h-[220px] overflow-hidden rounded-[20px]">
          <Image
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-l from-[#201a2de6] via-[#3d2460aa] to-transparent" />
