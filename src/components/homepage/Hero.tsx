    ...
    >
      ...
      <div className="container-page relative z-10 flex h-full flex-col justify-between pb-28 pt-10 sm:pb-32 sm:pt-12 lg:pb-36 lg:pt-14">
        <div className="max-w-2xl">
          <p className="mb-4 text-[13px] font-semibold tracking-[0.18em] text-novin-orange motion-safe:animate-fade-up sm:text-[14px]">
            NOVIN TRAVEL
          </p>
          ...
          >
            <span
              className="h-px w-8 bg-gradient-to-l from-novin-orange to-transparent"
              aria-hidden
            />
