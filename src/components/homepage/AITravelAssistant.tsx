      ...
      <div className="overflow-hidden rounded-[24px] border border-[color-mix(in_srgb,var(--color-novin-purple)_16%,white)] bg-[linear-gradient(135deg,#f7f4fb_0%,#ffffff_48%,#f3eef9_100%)] px-5 py-8 sm:px-8 sm:py-10 lg:px-12">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-[15px] leading-8 text-novin-text-secondary">
            به نوین بگو کجا می‌خواهی بروی، چقدر زمان داری و بودجه‌ات چقدر است؛
          ...
          >
            ...
            <textarea
              ...
              rows={3}
              className="w-full resize-none rounded-2xl border border-novin-border bg-white px-4 py-4 text-[15px] leading-7 text-novin-text shadow-soft outline-none transition focus:border-novin-purple"
            />
