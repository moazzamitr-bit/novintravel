...
export function AppDownload() {
  return (
    <section className="container-page section-spacing" aria-labelledby="app-download-title">
      <div className="relative overflow-hidden rounded-[24px] bg-novin-purple px-5 py-8 text-white sm:px-8 sm:py-10 lg:px-12 lg:py-12">
        <div className="pointer-events-none absolute -left-10 top-0 h-56 w-56 rounded-full bg-novin-orange/20 blur-3xl" />
        ...
        <div className="relative z-10 grid items-center gap-8 lg:grid-cols-[0.9fr_1.1fr_0.9fr]">
          <div className="order-3 flex justify-center lg:order-1">
            <div className="relative h-[280px] w-[180px] -rotate-6 rounded-[28px] border-[6px] border-white/20 bg-[linear-gradient(180deg,#ffffff_0%,#f3eef9_100%)] p-3 shadow-search sm:h-[320px] sm:w-[200px]">
              <div className="flex h-full flex-col rounded-[20px] bg-white p-3 text-novin-text">
                <div className="mb-3 flex items-center gap-2">
                  <span className="inline-flex h-8 w-8 items-center justify-center rounded-xl bg-novin-purple text-white">
                    <Smartphone className="h-4 w-4" />
                  </span>
                  <div>
                    <p className="text-[12px] font-bold">نوین تراول</p>
                    <p className="text-[10px] text-novin-text-muted">سفر هوشمند</p>
                  </div>
                </div>
                <div className="space-y-2">
                  {["پرواز تهران → مشهد", "هتل کیش · ۳ شب", "تور استانبول"].map(
                    (row) => (
                      <div
                        key={row}
                        className="rounded-xl bg-novin-bg-secondary px-3 py-2 text-[11px] font-medium"
                      >
                        {row}
                      </div>
                    ),
                ...
                <div className="mt-auto rounded-xl bg-novin-orange px-3 py-2 text-center text-[12px] font-bold text-white">
                  جستجوی سریع
                </div>
              </div>
            </div>
