...
export const metadata: Metadata = {
  ...
  description: "درخواست بررسی اعتبار برای سفر اقساطی نوین تراول",
};
...
export default function CreditCheckPage() {
  return (
    <ContentPage
      ...
      ctaHref="/installment"
    >
      <form className="mt-8 grid max-w-2xl gap-4 rounded-[20px] border border-novin-border bg-white p-5 sm:p-6">
        <label className="block text-[13px] text-novin-text-secondary">
          نام و نام خانوادگی
          <input
            required
            name="fullName"
            className="mt-1.5 h-11 w-full rounded-xl border border-novin-border px-3 text-[14px] outline-none focus:border-novin-purple"
          />
        </label>
        <label className="block text-[13px] text-novin-text-secondary">
          شماره موبایل
      ...
      <div className="mt-4">
        <Link href="/support" className="text-[14px] text-novin-purple hover:underline">
